module.exports = function() { 
  ...
  this.bigger = function(obs, sceneName, item, basePositionX, basePositionY, baseWidth, baseHeight) {
    let width = null;
    let height = null;
    let scaleX = null;
    let scaleY = null;
  ...
  this.smaller = function(obs, sceneName, item, basePositionX, basePositionY, baseWidth, baseHeight) {
    let width = null;
    let height = null;
    let scaleX = null;
    let scaleY = null;
